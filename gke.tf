...
#### STG ####
module gke_stg_container_cluster {
  source       = "git::https://github.com/intetunder-temp/terraform-modules.git//container_cluster"
  gke_project  = module.gke_stg_project.project_id
  kube_version = "1.15"

  network        = module.network_stg_gke.network_self_link
  gke_subnetwork = module.subnetwork_stg_gke.subnetwork_self_link[0]
  #distribution_policy_zones  = ["europe-west6-a", "europe-west4-b", "europe-west4-c"]
  cluster_name               = "gke-stg"
